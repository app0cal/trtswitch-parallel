...
debug_aft_llik_score_info <- function(data1, covariates_aft, dist, alpha = 0.05) {
    .Call(`_trtswitch_debug_aft_llik_score_info`, data1, covariates_aft, dist, alpha)
}
...
test_kmest_pure <- function(time, event, conftype = "log‐log", conflev = 0.95, keep_censor = FALSE) {
    .Call(`_trtswitch_test_kmest_pure`, time, event, conftype, conflev, keep_censor)
}
