...
// test_kmest_pure
DataFrame test_kmest_pure(NumericVector time, IntegerVector event, std::string conftype, double conflev, bool keep_censor);
RcppExport SEXP _trtswitch_test_kmest_pure(SEXP timeSEXP, SEXP eventSEXP, SEXP conftypeSEXP, SEXP conflevSEXP, SEXP keep_censorSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type time(timeSEXP);
    Rcpp::traits::input_parameter< IntegerVector >::type event(eventSEXP);
    Rcpp::traits::input_parameter< std::string >::type conftype(conftypeSEXP);
    Rcpp::traits::input_parameter< double >::type conflev(conflevSEXP);
    Rcpp::traits::input_parameter< bool >::type keep_censor(keep_censorSEXP);
    rcpp_result_gen = Rcpp::wrap(test_kmest_pure(time, event, conftype, conflev, keep_censor));
    return rcpp_result_gen;
END_RCPP
}
// tsegestcpp
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_trtswitch_test_kmest_pure", (DL_FUNC) &_trtswitch_test_kmest_pure, 5},
